...
let formId ,fname,Sname,lname,SLname,fage,sAge,dob,sDob,genderMale,genderFemale,sGender,Html,Java,python,scourses;
let  mobileNo ,sMobileNo ,password,sPassword ,sConfirm_Password ,confirm_Password ,  sPinCode ,pinCode;
